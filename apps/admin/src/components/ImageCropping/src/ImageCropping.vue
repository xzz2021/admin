      ...
      <div v-if="showActions" class="mt-10px flex items-center">
        <div class="flex items-center">
          <ElTooltip content="选择文件" placement="bottom">
            ...
            >
              <BaseButton size="small" type="primary" class="mt-2px"><Icon icon="vi-ep:upload-filled" /></BaseButton>
            </ElUpload>
          </ElTooltip>
        </div>
        <div class="flex items-center justify-end flex-1">
          <ElTooltip content="重置" placement="bottom">
            <BaseButton size="small" type="primary" @click="reset"><Icon icon="vi-ep:refresh" /></BaseButton>
          </ElTooltip>
