...
import {
  CompleteDepartment,
  RelatedDepartmentModel,
  CompleteUserRole,
  RelatedUserRoleModel,
  CompleteUserSession,
  RelatedUserSessionModel,
  CompleteAuditLog,
  RelatedAuditLogModel,
  CompleteUserOperationLog,
  RelatedUserOperationLogModel,
} from './index';
...
export const UserModel = z.object({
  ...
  phone: z
    ...
    .meta({ description: '手机号', example: '13800138000' }),
 ...
 */
export const RelatedUserModel: z.ZodType<CompleteUser> = z.lazy(() =>
  UserModel.extend({
